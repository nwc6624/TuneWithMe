...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-primary">
      ...
      <div className="py-20 bg-background-secondary landing-section-bg">
        <div className="container mx-auto px-4">
          <h2 className="text-4xl font-bold text-center text-extra-high-contrast mb-16 landing-title">
            How It Works
          </h2>
          ...
          <div className="grid md:grid-cols-2 gap-16 items-center">
            {/* Host side */}
            <div>
              <h3 className="text-2xl font-semibold text-extra-high-contrast mb-6 flex items-center landing-subtitle">
              ...
              <div className="space-y-4">
                <div className="flex items-start space-x-3">
                  ...
                  <p className="text-high-contrast landing-text">
      ...
      {/* Footer */}
      <div className="py-12 bg-background-primary border-t border-surface-tertiary/20 landing-section-bg">
        <div className="container mx-auto px-4 text-center">
          <p className="text-high-contrast landing-footer-text">
            © 2024 TuneWithMe. Built with ❤️ for music lovers and streamers.
          </p>
          <p className="text-sm text-medium-contrast mt-2 landing-footer-subtext">
