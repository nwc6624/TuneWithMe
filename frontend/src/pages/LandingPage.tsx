    ...
    <div className="min-h-screen bg-primary">
      ...
      <div className="py-20 bg-background-secondary">
        <div className="container mx-auto px-4">
          <h2 className="text-4xl font-bold text-center text-extra-high-contrast mb-16">
            How It Works
          </h2>
          ...
          <div className="grid md:grid-cols-2 gap-16 items-center">
            {/* Host side */}
            <div>
              <h3 className="text-2xl font-semibold text-extra-high-contrast mb-6 flex items-center">
